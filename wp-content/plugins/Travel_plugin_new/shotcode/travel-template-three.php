...
wp_enqueue_style('font-awesome-temp3-css', '//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.2/css/all.min.css');
wp_enqueue_style('custom-tempate3-css', path . '/shotcode/css/cards-theme-three.css');
wp_enqueue_style('cust_font3', '//fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500;600;700;900&display=swap');
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content " style="margin-top:125px;">
      ...
      <!-- Modal Header -->
      <div class="modal-header" style="background:#ffd600;">
        <h4 class="modal-title text-center">Query Form</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <!-- Modal body -->
      <div class="modal-body modal_sty">
            <form action="<?php echo admin_url('admin-ajax.php') ?>" name="query__Form" method="POST" id="query__Form" class="ajax">
                ...
                <button class="btn-large btn-info my-3 q_btn" type="submit"name="query_submit">Submit</button>
            </form>
      </div>
