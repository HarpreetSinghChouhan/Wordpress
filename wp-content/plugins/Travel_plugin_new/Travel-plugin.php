...
//ADMIN CSS & JS FILES
add_action('admin_enqueue_scripts', 'ecs_travel_package_admin_script2');
function ecs_travel_package_admin_script2($hook)
{
    ...
    <div class="wrap">
        ...
        <form method="post" action="">
            ...
            <table class="form-table" role="presentation">
                <tbody>
                    <tr>
                        <td><input class="hid_radio" type="radio" name="single_page_" id="single_page_1" value="single_page_1" <?php if ($single_page_val == "single_page_1") {
                                                                                                                                    echo "checked";
                                                                                                                                } else {
                                                                                                                                    echo "";
                                                                                                                                } ?>>
                        ...
                        <td>
                            <input class="hid_radio" type="radio" name="single_page_" id="single_page_2" value="single_page_2" <?php if ($single_page_val == "single_page_2") {
                                                                                                                                    echo "checked";
                                                                                                                                } else {
                                                                                                                                    echo "";
                                                                                                                                } ?>>
                        ...
                        <td>
                            <input class="hid_radio" type="radio" name="single_page_" id="single_page_3" value="single_page_3" <?php if ($single_page_val == "single_page_3") {
                                                                                                                                    echo "checked";
                                                                                                                                } else {
                                                                                                                                    echo "";
                                                                                                                                } ?>>
                        ...
                        <td>
                            <input class="hid_radio" type="radio" name="single_page_" id="single_page_4" value="single_page_4" <?php if ($single_page_val == "single_page_4") {
                                                                                                                                    echo "checked";
                                                                                                                                } else {
                                                                                                                                    echo "";
                                                                                                                                } ?>>
 ...
 */
        ...
        .exclusive-deals .owl-nav.disabled,
        .exclusive-deals .owl-nav {
            display: block;
            position: absolute;
            top: 4px !important;
            right: 0;
        ...
        .bookingsection button.popmake-2013.pum-trigger:hover,
        .bookingsection button.popmake-2013.pum-trigger:focus {
...
function ecs_custom_db_table()
{
    ...
    $sql = "CREATE TABLE $table_name (id mediumint(9) NOT NULL AUTO_INCREMENT,name varchar(255) DEFAULT '' NOT NULL,last_name varchar(255) DEFAULT '' NOT NULL,mobile varchar(255) DEFAULT '' NOT NULL,email varchar(255) DEFAULT '' NOT NULL,__query varchar(255) DEFAULT '' NOT NULL,date varchar(255) DEFAULT '' NOT NULL,_permalink varchar(255) DEFAULT '' NOT NULL,call_email varchar(255) DEFAULT '' NOT NULL,created_at  TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY  (id) ) $charset_collate;";
        ...
        if (is_post_type_archive('travel-package') || isset($_GET['location']) || isset($_GET['package_category'])) {
            ...
            if (isset($_GET['location']) && !empty($_GET['location'])) {
                ...
                $terms = $wpdb->get_results($wpdb->prepare(
                    ...
                    '%' . $wpdb->esc_like($search_term_slug) . '%'
                ));
...
{
    if (isset($_GET['taxonomy']) && ($_GET['taxonomy'] === 'package_category' || $_GET['taxonomy'] === 'location')) {
        wp_enqueue_media();
